...
const BrandsToBag = ({ image1, image2, image3, image4 }) => {
  return (
    <div className="bg-gray-200 w-fit m-1 p-2 rounded-xl">
      <p className="flex">
        <img src={image1} alt="" className="w-1/2 h-fit border-8" />
        <img src={image2} alt="" className="w-1/2 h-fit border-8" />
      </p>
      <p className="flex">
        <img src={image3} alt="" className="w-1/2 h-fit border-8" />
        <img src={image4} alt="" className="w-1/2 h-fit border-8" />
      </p>
      <p className="ml-4">
...
const TrendingInFashion = ({ image }) => {
  return (
    <div className="bg-gray-200 w-fit m-1 p-2 rounded-xl mb-8">
      <p className="flex w-fit flex items-center justify-center">
        <img src={image} alt="" className="w-full border-8" />
      </p>
      <p className="flex bg-white border-8 mt-0 h-20 justify-center rounded-xl">
        HELLO
      </p>
      <p className="ml-4">
        <Link className="underline">{"Explore More"}</Link>
...
const TrendingInGrocery = ({ logo, image }) => {
  return (
    <div className="bg-gray-200 w-fit  m-1 p-8 rounded-xl">
